...
use Pizza\shopBundle\Form\UserType;
...
class UserController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('PizzashopBundle:User')->findAll();
     ...
     *
     * @Route("/register/create", name="shop_create")
     * @Method("POST")
     * @Template("PizzashopBundle:User:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('PizzashopBundle:User')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("PizzashopBundle:User:edit.html.twig")
     */
